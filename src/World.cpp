...
static void buildLitTriangles(
    World& world, sf::Vector2f source, sf::Vector2f cameraCenter,
    float halfViewW, float halfViewH,
    float maxDistance, unsigned int unit_size, sf::VertexArray& out)
{
    constexpr float PI = 3.14159265359f;
